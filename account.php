    ...
    <div class="container">
        ...
        <div class="bg-white rounded shadow p-2 mt-4">
            <div class="d-flex justify-content-between border-bottom">
                <h5>Account</h5>
                <div>
                    <a class="text-decoration-none" onclick='history.back()' style="color: #910075; font-weight:500;"><i class="bi bi-arrow-left-circle"></i> Back</a>
                </div>
            </div>
            ...
            <div>
                ...
                <form action="actions/updateprofile.action.php" method="post" class="row g-3 p-3">
                    ...
                    <div class="col-12 text-end">
                        <button type="submit" class="btn" style="background-color: #910075;color:white; font-weight:600;"><i class="bi bi-floppy"></i> Update
                            Profile</button>
                    </div>
                </form>
            </div>
