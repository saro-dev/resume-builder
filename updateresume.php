    ...
    <div class="container">
        ...
        <div class="bg-white rounded shadow p-2 mt-4" style="min-height:80vh">
            <div class="d-flex justify-content-between border-bottom">
                <h5>Create Resume</h5>
                <div>
                     <a href="myresumes.php" class="text-decoration-none" style="color: #910075; font-weight:500;"><i class="bi bi-arrow-left-circle"></i> Back</a>
                </div>
            </div>
            ...
            <input type="hidden" name="slug" value="<?=$resume['slug']?>" />
                ...
                <h5 class="mt-3 text-secondary"><i class="bi bi-person-badge"></i> Personal Information</h5>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" min="1111111111" value="<?=@$resume['mobile_no']?>" name="mobile_no" placeholder="9569569569" max="9999999999"
                    ...
                    <div class="col-12">
                        ...
                        <input type="text"  value="<?=@$resume['address']?>"  class="form-control" name="address" id="inputAddress" placeholder="1234 Main St" required>
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <a class="text-decoration-none" data-bs-toggle="modal" data-bs-target="#addexp" style="color: #910075; font-weight:500;"><i class="bi bi-file-earmark-plus"></i> Add New</a>
                        </div>
                    </div>
...
?>
 <div class="col-12 col-md-6 p-2">
                            <div class="p-2 border rounded">
                                ...
                                <p class="small text-secondary m-0" style="">
                                    if you have experince, you can add it
                                </p>
...
?>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <a href="" class="text-decoration-none" style="color: #910075; font-weight:500;" data-bs-toggle="modal" data-bs-target="#addedu"><i class="bi bi-file-earmark-plus"></i> Add New</a>
                        </div>
                    </div>
...
?>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <a href="" class="text-decoration-none"  data-bs-toggle="modal" data-bs-target="#addskill" style="color: #910075; font-weight:500;"><i class="bi bi-file-earmark-plus" ></i> Add New</a>
                        </div>
                    </div>
...
?>
                    ...
                    <div class="col-12 text-end">
                        <button type="submit" class="btn" style="background-color: #910075;color:white; font-weight:500;"><i class="bi bi-floppy"></i> Update
                            Resume</button>
                    </div>
                </form>
            </div>
...
<div class="modal fade" id="addexp" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  ...
  <div class="col-12 text-end">
    <button type="submit" class="btn" style="background-color: #910075;color:white; font-weight:600;">Add Experience</button>
  </div>
</form>
      </div>
...
<div class="modal fade" id="addedu" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  ...
  <div class="col-12 text-end">
    <button type="submit" class="btn" style="background-color: #910075;color:white; font-weight:600;">Add Education</button>
  </div>
</form>
      </div>
...
<div class="modal fade" id="addskill" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  ...
  <div class="col-12 text-end">
    <button type="submit" class="btn " style="background-color: #910075;color:white; font-weight:600;">Add Skill</button>
  </div>
</form>
      </div>
