            ...
            <div>
                ...
                <form action="actions/createresume.action.php" method="post" class="row g-3 p-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="full_name" placeholder="Saravanan" class="form-control" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Email</label>
                        <input type="email" name="email_id" placeholder="saro@abc.com" class="form-control" required>
                    </div>
                    <div class="col-12">
