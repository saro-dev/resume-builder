...
<body>
    ...
    <style>
        body {
            ...
            background: rgb(255,114,227);
	    background: radial-gradient(circle, rgba(255,114,227,1) 0%, rgba(255,171,239,1) 52%, rgba(199,245,255,1) 100%);
...
if($fn->Auth()!=false && $fn->Auth()['id']==$resume['user_id']){
    ?>
<div class="extra">
<div class="w-100 py-2 d-flex justify-content-center gap-3" style="background-color:#910075; color:white;">
    <?php
